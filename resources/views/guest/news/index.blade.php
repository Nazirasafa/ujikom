                ...
                <div class="flex flex-col items-center p-6 text-gray-900">
                    <div class="flex flex-wrap justify-center w-full mt-3">
                        @foreach ($newses as $news)
                            <div
                                class="relative overflow-hidden flex flex-col h-[26rem] m-3 group transition-all duration-500 bg-white w-80 rounded-xl hover:drop-shadow-2xl drop-shadow-lg hover:scale-110">
